                ...
                <div className="transition-all duration-300">
                  ...
                  {user && (
                    <p className="text-xs text-slate-500 mt-1 font-medium">
                     <span className="text-slate-700">{user.user_code || user.employeeId}</span>
                    </p>
                  )}
                </div>
              )}
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-slate-200/60 shadow-sm hover:shadow-md transition-all duration-300">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-bold text-slate-800 truncate">{user.user_code || user.employeeId}</p>
